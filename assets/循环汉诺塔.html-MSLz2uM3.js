import{_ as a,r as e,o as t,c as p,b as n,d as o,e as l,a as c}from"./app-CrKXQHLj.js";const i={},r=c(`<h1 id="循环汉诺塔" tabindex="-1"><a class="header-anchor" href="#循环汉诺塔"><span>循环汉诺塔</span></a></h1><h2 id="描述" tabindex="-1"><a class="header-anchor" href="#描述"><span>描述</span></a></h2><p>Eli最近迷上了汉诺塔。她玩了传统汉诺塔后突发奇想，发明了一种新的汉诺塔玩法。 有A、B、C三个柱子顺时针放置，移动的次序为A仅可以到B，B仅可以到C、C仅可以到A。即只可顺时针移动，不可逆时针移动。当然，汉诺塔的普适规则是适用的：每次移动后，大金片必须在小金片的下面。 现在A柱子上有n n 个金片。Eli想知道，她把这些全部移动到B或C，分别要多少次操作？</p><h2 id="思路" tabindex="-1"><a class="header-anchor" href="#思路"><span>思路</span></a></h2><p>利用状态转移方程，由于不用求具体过程，找到一步步叠加的状态。\\</p><p>AB(N) :表示N个移动一格 AC(N) ：表示N个移动两格</p><p>找到规律：AB(1) = 1; AC(1) = 2; AB(2) = 5; AC(2) =7; AC(1) =2 <em>AB(1); AC(2)&lt; 2</em>AB(2); 所以当要移动n-1时，尽可能两个移动。</p><p>状态转移： AC(N) =AC(N-1)+AB(1)+CA(N-1)+BC(1)+AC(N-1)</p><pre><code>     AB(N) = AC(N-1)+AB(1)+CB(N-1)
